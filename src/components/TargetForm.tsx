 ...
 *   onSubmit={async (target) => targetsApi.createTarget(target)}
 *   onCancel={() => setFormOpen(false)}
 * />
 * ```
 *
 * Omit `initialData` when creating a target. When kubeconfig authentication is
 * selected, users can paste the content or choose a local file; the component
 * submits the kubeconfig as base64-encoded data through `onSubmit`.
 */
